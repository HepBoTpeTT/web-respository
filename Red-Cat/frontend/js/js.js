...
var pageNavigation = [...document.querySelectorAll("#menu .menu-item")]
document.querySelector("#menu").addEventListener("onclick", (e) => {
    index = pageNavigation.indexOf(e.target);
    console.log(e.target);
    if (~index){
        document.querySelector("#menu a.active").classList.remove("active")
        e.target.querySelector("a").classList.add("active")
    }
});
